...
Generate Algorithm:
    ...
    2. Decide the fitness function for the agent in the swarm (Y)
...
Personal Log:
    1. The result is better than the PSO Algorithm, but it still truck in the local optimization, the solution ?
        1. One solution is try to add the beta (Mutation Possibility) to extend the search area in this TSP problem
         ---- I set the mutation possibility as 1, and it work well.
...
if __name__ == "__main__":
    ...
    t = main(100, dimension, cities_map, 2000, 20, 100, 0.9, 1, 5, 10)
    c = 0
    for i, j ,k in t:
